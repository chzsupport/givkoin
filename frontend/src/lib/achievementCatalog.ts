...
13→Разрушитель Оков — Нанести урон, который сдвинул ползунок личного сектора из -50 сразу в +10.
...
16→Стена Света — Удерживать ползунок в зоне +50 более 10 минут.
...
41→Хозяин Сектора — Закончить бой с показателем +50 на ползунке.
42→На грани — Удержать ползунок на 0, не давая Мраку перевесить.
43→Камбэк года — Выйти из зоны -50 в зону +50 к концу боя.
44→Непоколебимый остров — Ни разу за бой не позволить ползунку уйти в минус.
45→Герой Ветви — Победить в своем секторе, когда Древо в целом проигрывает.
...
72→Неудержимая Серия — Победить в 5 боях подряд, закончив каждый с показателем ползунка +30 и выше.
...
13→Chainbreaker — Deal damage that moves your personal sector slider from -50 straight to +10.
...
16→Wall of Light — Keep the slider in the +50 zone for more than 10 minutes.
...
41→Master of the Sector — Finish the battle with the slider at +50.
42→On the Edge — Hold the slider at 0 without letting Darkness take over.
43→Comeback of the Year — Move from -50 to +50 by the end of the battle.
44→Unshaken Island — Never let the slider go below zero during the battle.
45→Branch Hero — Win your sector when the Tree as a whole is losing.
...
72→Unstoppable Streak — Win 5 battles in a row, ending each one with the slider at +30 or higher.
